...
class Model(object):
    ...
    """
    helper method for runModel(), draws a single intersection
    at a position on the grid specified by the row and column
    parameters.
    """
    ...
    def runModel(self, vis = False):
        if vis:
            ...
            img = ax.imshow(self.data, interpolation='none',
